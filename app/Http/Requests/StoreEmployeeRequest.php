...
class StoreEmployeeRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'employee_address.residence_zip_code' => ['required', 'string'],
            'employee_address.residence_city' => ['required', 'string'],
            'employee_address.residence_street' => ['required', 'string'],
            'employee_address.residence_building_number' => ['required', 'string'],
            'employee_address.residence_apartment_number' => ['nullable', 'string'],
            ...
            'employee_address.correspondence_zip_code' => ['required_if_accepted:employee_address.different_correspondence_address', 'string'],
            ...
            'employee_address.correspondence_building_number' => ['required_if_accepted:employee_address.different_correspondence_address', 'string'],
            'employee_address.correspondence_apartment_number' => ['nullable', 'string'],
        ];
    }
